...
- **Frontend**: See `frontend/AGENTS.md` for Svelte 5, TypeScript, UI
- **Backend**: See `internal/AGENTS.md` for Go standards, testing
- **API v2**: See `internal/api/v2/AGENTS.md` for endpoints
- **Testing**: See `TESTING.md` for test patterns, testify usage, shared helpers

**IMPORTANT**: Always read the relevant AGENTS.md file before working on code:

- Working on Go code? Read `internal/AGENTS.md` first
- Working on frontend? Read `frontend/AGENTS.md` first
- Working on API v2? Read `internal/api/v2/AGENTS.md` first
